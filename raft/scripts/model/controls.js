...
define([], function () {
    function Controls(model) {
        ...
        this.resume = {
            ...
            html: function() {
                return '<button type="button" style="visibility:hidden" class="btn btn-default resume" alt="Continue to next frame">继续 <span class="glyphicon glyphicon-chevron-right"></span></button>';
            },
            click: function() {
